...
export function realtimeInstruction(voiceId?: string, master?: string, slave?: string, temporal?: { tz: string; today: string }): string {
...
- ALWAYS say the time window your answer covers ("For last December…", "Over your last 7 days…"). The manager's picker is the default; if they name their own dates, report those. Never give a time-scoped number without saying which window it is.
