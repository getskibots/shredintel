...
/**
 * Branded "shredding the data" overlay: a scan band sweeps top→bottom over the
 * content, plus a centered pill naming the range. The parent must be `relative`;
 * this is pointer-events-none so it never blocks interaction.
 */
export function ShreddingOverlay({ active, label }: { active: boolean; label?: string }) {
