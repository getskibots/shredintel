...
export interface VoiceProfile {
  ...
  match: RegExp // preferred browser-voice name
}

export const VOICE_PROFILES: VoiceProfile[] = [
  { id: 'old-man-winter', name: 'Old Man Winter', blurb: 'Gruff, weathered wisdom', pitch: 0.7, rate: 0.92, match: /daniel|david|fred|alex|male|guy/i },
  { id: 'summer', name: 'Summer', blurb: 'Bright and upbeat', pitch: 1.18, rate: 1.08, match: /samantha|zira|karen|victoria|jenny|female/i },
  { id: 'autumn', name: 'Autumn', blurb: 'Warm and reflective', pitch: 1.0, rate: 0.98, match: /moira|serena|tessa|aria|female/i },
]
